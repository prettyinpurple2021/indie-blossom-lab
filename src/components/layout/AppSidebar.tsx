                  ...
                  <SidebarMenuButton asChild>
                    <NavLink 
                      ...
                      className={cn(
                        "flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all duration-300",
                        "hover:bg-primary/10 hover:text-primary",
                        location.pathname === '/admin/announcements' && "bg-primary/20 text-primary shadow-[inset_0_0_20px_hsl(270_80%_60%/0.1)] border-l-2 border-primary"
                      )}
                    >
                      <Megaphone className="h-5 w-5 flex-shrink-0 text-warning drop-shadow-[0_0_6px_hsl(var(--warning)/0.5)]" />
